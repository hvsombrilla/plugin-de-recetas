        ...
        if(is_array($data)) {
            ...
            foreach ($values as $value) {
                ...
                elseif ($value && !empty($model) ) {
                    ...
                    $links[] = '<li class="tr-link-chosen-item">' . $selection . $item['title'] . ' <a title="remove" class="tr-control-icon tr-control-icon-remove tr-link-chosen-item-remove dashicons-before dashicons-trash"></a></li>';
                }
                elseif( $value ) {
                    $post = get_post($value);
                    $status = '';
                    ...
                    $links[] = '<li class="tr-link-chosen-item">' . $selection . $post->post_title . ' (' . $status . $post->post_type . ') <a title="remove" class="tr-control-icon tr-control-icon-remove tr-link-chosen-item-remove dashicons-before dashicons-trash"></a></li>';
                }
            }
        }
